...
module.exports = {
    ...
    async execute(interaction) {
		...
		if (!language) {
			...
			language = "english"
			console.log(`🏳 Succesfully configured ${interaction.guild.name}'s language.`)
			interaction.reply({content: "Bot succesfully configured! Please type your command again.", ephemeral: true})
			const brek = "stop"
			return brek
		}
		const filePath = path.join(__dirname, `../../Data/localisation/descriptions/${language.Language}.json`);
                ...
                .map((cmd) => {
                    return {
                        ...
                        description:
                            ...
                            localisation.help.noDescription,
                    };
                });
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor("#235ee7")
            .setAuthor({ name: `Komendy mangobota:`, iconURL: client.user.avatarURL() });
